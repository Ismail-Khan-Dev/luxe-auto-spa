...
const features = [
  ...
  'Ceramic spray coating (6–12 months)',
  'Wheel sealant + tire dressing',
];

export default function ProtectionSection({ className = '' }: ProtectionSectionProps) {
    ...
    >
      ...
      >
        <img
          ...
          alt="Car paint protection with water beading"
